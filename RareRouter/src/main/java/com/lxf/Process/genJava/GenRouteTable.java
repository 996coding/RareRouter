...
public class GenRouteTable {

    public static final String CLASS_NAME = "RecordRouteInfo";
    ...
    private static String createInfoClass(List<Bean> beanList) {
        ...
        sb.append(infoHead());
        sb.append(infoFiled_Arr(beanList));
        sb.append(createImpFun());
        sb.append(infoTail());
        return sb.toString();
    }
    ...
    private static String infoImport() {
        ...
        sb.append("import com.lxf.nozzle.AbsRecordRoute;\n");
        sb.append("import com.lxf.init.RouteBean;\n\n");
        return sb.toString();
    }

    private static String infoHead() {
        return "public class " + GenRouteTable.CLASS_NAME + "  extends AbsRecordRoute{ \n\n";
    }
