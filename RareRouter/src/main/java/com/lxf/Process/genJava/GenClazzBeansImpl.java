...
public class GenClazzBeansImpl {

    public static String CLASS_NAME = "ClazzBeansImpl";
    ...
    private static String class_import() {
        ...
        sb.append("import com.lxf.protocol.ClazzBeans;\n\n");
        return sb.toString();
    }
    ...
    private static String method_head() {
        StringBuilder sb = new StringBuilder();
        sb.append("    @Override\n");
        sb.append("    public RouteBean clazzRouteBean(String annotationPath) {\n");
        return sb.toString();
    }
